	...
	<div class="container">
		<div class="jumbotron">
			...
			<form action="${pageContext.request.contextPath}/controller.do" method="POST" class="form-horizontal">
					...
					<input id="fone" value="${contato.fone}" name="fone" type="text" class="form-control" placeholder="Fone" />
					...
					<select class="form-control" id="operadora" name="operadora">
						<option value="${null}" label="Selecione operadora">Selecione a operadora </option>
